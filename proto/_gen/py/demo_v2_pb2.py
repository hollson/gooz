...
_CHATMSG = _descriptor.Descriptor(
  name='ChatMsg',
  full_name='pbs.ChatMsg',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='talker', full_name='pbs.ChatMsg.talker', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='content', full_name='pbs.ChatMsg.content', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='msgType', full_name='pbs.ChatMsg.msgType', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='receiveWxId', full_name='pbs.ChatMsg.receiveWxId', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='thImgVideo', full_name='pbs.ChatMsg.thImgVideo', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='videolength', full_name='pbs.ChatMsg.videolength', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='createTime', full_name='pbs.ChatMsg.createTime', index=6,
...
_IDENTITY = _descriptor.Descriptor(
  name='Identity',
  full_name='pbs.Identity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='shopId', full_name='pbs.Identity.shopId', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='userId', full_name='pbs.Identity.userId', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='token', full_name='pbs.Identity.token', index=2,
...
_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='pbs.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='cmd', full_name='pbs.Operation.cmd', index=0,
      number=1, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='pbs.Operation.data', index=1,
      number=2, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
